...
-------------------    ---------------------------------------------------------------------
CLK (A pin)            any microcontroler intput pin with interrupt -> in this example pin 6
DT (B pin)             any microcontroler intput pin with interrupt -> in this example pin 5
SW (button pin)        any microcontroler intput pin with interrupt -> in this example pin 4
...
static const uint16_t PROGMEM	// TODO Checken ob dies auf dem ESP32 geht
